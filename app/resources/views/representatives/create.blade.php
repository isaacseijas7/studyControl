...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> Registrar Repesentante</li>
    </ol>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        {!! Form::open(['route' => 'representatives.store', 'method' => 'POST','id'=>'representatives_form', 'name'=>'representatives_form']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('profession') ? ' has-danger' : '' }}"">
                                        ...
                                        {{ Form::text('profession', old('profession'), ['class' => 'form-control', 'id' => 'profession' , 'placeholder' => 'Profesión' ]) }}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('work_place') ? ' has-danger' : '' }}"">
                                        ...
                                        {{ Form::text('work_place', old('work_place'), ['class' => 'form-control', 'id' => 'work_place' , 'placeholder' => 'Dirección de trabajo' ]) }}
