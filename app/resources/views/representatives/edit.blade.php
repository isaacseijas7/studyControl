            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        {!! Form::model($representative,['route' => ['representatives.update',$representative->representative->id], 'method' => 'PUT', 'id'=>'representatives_form', 'name'=>'representatives_form']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('profession') ? ' has-danger' : '' }}"">
                                        {{ Form::label('profession', 'Profesión:', ['for' => 'profession', 'class'=>'control-label']) }}

                                        {{ Form::text('profession', $representative->representative->profession, ['class' => 'form-control', 'id' => 'profession' , 'placeholder' => 'Profesión' ]) }}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('work_place') ? ' has-danger' : '' }}"">
                                        {{ Form::label('work_place', 'Dirección de trabajo:', ['for' => 'work_place', 'class'=>'control-label']) }}

                                        {{ Form::text('work_place', $representative->representative->work_place, ['class' => 'form-control', 'id' => 'work_place' , 'placeholder' => 'Dirección de trabajo' ]) }}
                                        
                                        @if ($errors->has('work_place'))
                                            <span class="form-control-feedback">{{ $errors->first('work_place') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
