            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        {!! Form::open(['route' => 'students.store', 'method' => 'POST','id'=>'students_form', 'name'=>'students_form']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('diseases') ? ' has-danger' : '' }}"">
                                        ...
                                        {{ Form::textarea('diseases', old('diseases'), ['class' => 'form-control', 'id' => 'diseases' , 'placeholder' => 'Enfermedades' ]) }}
                            ...
                            <div class="card-footer">
                                {!! Form::submit('Registrar Estudiante', ['class' => 'btn btn-md btn-primary', 'id' => 'btn_submit']) !!}
