...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> Editar Obrero</li>
    </ol>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        {!! Form::model($worker,['route' => ['workers.update',$worker->worker->id], 'method' => 'PUT', 'id'=>'worker_form', 'name'=>'worker_form']) !!}
                            ...
                            <div class="card-footer">
                                {!! Form::submit('Editar Obrero', ['class' => 'btn btn-md btn-primary', 'id' => 'btn_submit']) !!}
                            </div>
                        {!! Form::close() !!}
